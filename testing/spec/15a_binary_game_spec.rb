...
describe BinaryGame do
  ...
  describe '#verify_input' do
    ...
    context 'when given a valid input as argument' do
      it 'returns valid input' do
        ...
        valid_input = 10
        expect(verify_input_game.verify_input(min, max, valid_input)).to eq(valid_input)
      end
    end
    ...
    context 'when given invalid input as argument' do
      it 'returns nil' do
        ...
        max = verify_input_game.instance_variable_get(:@maximum)
        invalid_input = 40
        expect(verify_input_game.verify_input(min, max, invalid_input)).to eq(nil)
      end
    end
  end
  ...
  describe '#display_binary_search' do
    ...
    context 'when game_over? is false five times' do
      before do
        input = Array.new(5, false) + [true]
        allow(search_display).to receive(:game_over?).and_return(*input)
      end
  ...
  describe '#display_turn_order' do
    ...
    before do
      ...
      allow(game_display).to receive(:display_guess).with(search_display)
